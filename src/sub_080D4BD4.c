...
void sub_080D4BD4(void *arg0) {
  ...
  if (temp_r5 == 0) {
    temp_r0 = func_080D2450(
        arg0, 0, 0, (s16)(*(s32 *)((char *)arg0 + 4) - 0x10),
        (s32) * (s16 *)((char *)arg0 + 0x90), 0x20, 0x080D3F6D, 1);
  ...
  }
  {
    ...
    if (c) {
      ...
      if (var_r1 == ((*(volatile u32 *)((char *)temp_r0_2 + 0x2C) >> 2) + 0x19))
        func_08095114(arg0);
    }
  }
}
