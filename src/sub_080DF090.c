...
void sub_080DF090(struct DF090Owner *arg0) {
    struct DF090Owner *owner = arg0;
    ...
    if (phase == 0) {
        ...
        *phase_slot = *phase_slot + 1;
        ...
        if (started_value == 0 &&
                *(u16 *)((u8 *)owner->children[0] + 0x14) == 2) {
            *phase_slot = 1;
            func_080D12A0(6, 0);
            func_080D2790(1);
        }
    ...
    {
        register void *child asm("r2") = owner->children[0];
        if (child != 0 && *(u16 *)((u8 *)child + 0x16) == 0) {
            func_08095208(
                ((s32)D_087A2CCC[*(u16 *)((u8 *)child + 0x14)] << 5) +
                    (s32)D_087A2B0C,
...

    {
        ...
        if (started != 0 &&
                (initial_count = *count_init, (u32)initial_count <= 0xE)) {
            ...
            trig = func_08092A90(
                (s16)func_080ECF00(initial_count << 7, 0xE));
            if (trig < 0) {
                trig += 3;
            }
            scaled = trig >> 2;
