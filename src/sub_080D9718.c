...
void sub_080D9718(void *arg0)
{
    register void *owner asm("r4") = arg0;
    register s32 *phase_slot asm("r5") = (s32 *)((u8 *)owner + 0x8C);
...
phase0:
    {
        ...
        child = func_080D2450(owner, 0, 0, (s16)x,
            *(s16 *)((u8 *)owner + 8), 0x20, 0x080D8D21, 1);
...
phase2:
    {
        ...
        bound += 0x11;
        child = child_init;
        if ((u32)index < bound && *(s32 *)((u8 *)owner + 0x4C) == 0) {
