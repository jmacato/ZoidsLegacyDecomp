...
void sub_080D63D0(void *arg0) {
    void *temp_r6 = *(void **)((char *)arg0 + 0x28);
    s32 var_r0;
    s32 var_r0_2;
    s32 temp_r2_2;
    ...
    *(u16 *)((char *)arg0 + 4) = var_r0;
    if (!(*(s32 *)((char *)arg0 + 0x2C) & 1)) {
        register s32 u asm("r0") = *(s32 *)((char *)arg0 + 0x34);
        register s32 temp_r5 asm("r5") = u + 1;
        s32 *dst;
        s32 idx;
        s32 r;
        s32 off;
        ...
        r = func_080D2660(temp_r6, temp_r5, 0, var_r0_2,
                (s32) *(s16 *)((char *)arg0 + 6), 0x500, 0, 0x80, 3);
        idx = (*(u32 *)((char *)arg0 + 0x2C) >> 1) + 0x18;
        off = idx << 2;
        dst = (s32 *)((char *)temp_r6 + 0xC);
        *(s32 *)((char *)dst + off) = r;
    }
