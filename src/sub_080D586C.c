    ...
    case 1: {
        if (*(u16 *)(*(char **)(owner + 0xC) + 0x14) == 5) {
            ...
            do {
                ...
                register s32 priority_base_r0 asm("r0");
                void *spawned;
                ...
                angle_r4 += 128;
                priority_r1 = (func_080ECD5C(*rng) * 0x201) >> 15;
                priority_base_r0 = 0x200;
                priority_r1 += priority_base_r0;
