...
void sub_080D6B2C(void *arg0) {
  ...
  if (temp_r5 == 0) {
    temp_r0 = func_080D2450(
        arg0, 0, 0, *(s16 *)((char *)arg0 + 4),
        (s32)(s16)(*(s32 *)((char *)arg0 + 8) + *(s32 *)((char *)arg0 + 0x94)),
        0x20, 0x080D63D1, 1);
  ...
  }
  {
    ...
    if (c) {
      ...
      if (((u32)var_r1 < temp_r2) && (*(s32 *)((char *)arg0 + 0x6C) == 0)) {
        u32 bound2 = temp_r2;
      ...
      if (var_r1 == ((*(volatile u32 *)((char *)temp_r0_2 + 0x2C) >> 1) + 0x19))
        func_08095114(arg0);
    }
  }
}
