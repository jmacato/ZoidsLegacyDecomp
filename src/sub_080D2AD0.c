...
void sub_080D2AD0(void *arg0) {
    s32 temp_r5;
    void *temp_r0;
    temp_r5 = *(s32 *)((u8 *)arg0 + 0x8C);
    if (temp_r5 == 0) {
        *(void **)((u8 *)arg0 + 0xC) = func_080D2450(arg0, 0, 1, *(s16 *)((u8 *)arg0 + 4), *(s16 *)((u8 *)arg0 + 8), 0x400, temp_r5, temp_r5);
        temp_r0 = func_080D2450(arg0, 1, 0, *(s16 *)((u8 *)arg0 + 4), *(s16 *)((u8 *)arg0 + 8), 0x100, 0x080D2529, temp_r5);
