...
M2C_UNK jtbl_080D5BD4();                            /* static */

void sub_080D5BAC(void *arg0, M2C_UNK arg3) {
    s32 temp_r1;
    ...
    case 1:
        ...
        if (temp_r0_2 <= 0x57U) {
            ...
            if (temp_r1 == 0) {
                ...
                func_080D2660(arg0, 1, 0, M2C_FIELD(arg0, s16 *, 4), (s32) (s16) (temp_r4 + (func_080ECF78(M2C_FIELD(arg0, u32 *, 0x90), 6) + (temp_r5 >> 0xE) + 0xFFFE)), 0x400, 0x80, 0x100, temp_r1);
            }
    ...
    case 3:
        ...
        if (temp_r1_2 <= 7U) {
            ...
            if (temp_r4_2 == 0) {
                ...
                var_r7 = 0;
                do {
                    temp_r4_3 = func_080ECD5C(*(s32 *)0x03000010);
                    temp_r5_3 = func_080ECD98(var_r7 << 5, 7);
                    asm volatile("" : "+r"(temp_r5_3));
                    {
                        register u32 product asm("r0") = temp_r4_3 * 9;

                        product >>= 0xF;
                        product += 0x6C;
                        temp_r5_3 += product;
                    }
                    temp_r0_4 = func_080D2660(arg0, 1, 0, M2C_FIELD(arg0, s16 *, 4), (s32) M2C_FIELD(arg0, s16 *, 8), 0x500, temp_r5_3, ((u32) (func_080ECD5C(*(s32 *)0x03000010) * 0x201) >> 0xF) + 0x200, 0);
                    {
