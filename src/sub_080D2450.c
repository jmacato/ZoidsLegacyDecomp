...
void *sub_080D2450(struct OwnerD2450 *owner, s32 type, s32 arg2,
    s32 arg3)
{
...

    {
        ...
        }
        {
            ...
            call3 = saved_arg3;
            return func_080D22B4(call0, call1, call2, call3);
        }
    }
}
